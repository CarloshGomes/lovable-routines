  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "glow-xl": "0 0 50px -10px hsl(var(--primary) / 0.5)",
        "inner-glow": "inset 0 0 20px -10px hsl(var(--primary) / 0.3)",
        "premium": "0 1px 2px hsl(var(--foreground) / 0.05), 0 4px 8px hsl(var(--foreground) / 0.04), 0 12px 24px hsl(var(--foreground) / 0.03)",
        "premium-lg": "0 2px 4px hsl(var(--foreground) / 0.04), 0 8px 16px hsl(var(--foreground) / 0.05), 0 24px 48px hsl(var(--foreground) / 0.06)",
      },
      backdropBlur: {
        "2xl": "40px",
        "3xl": "64px",
